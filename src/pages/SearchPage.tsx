...
import PaginationSelections from "@/components/PaginationSelections";
import SearchBar, { SearchForm } from "@/components/SearchBarHome/SearchBar";
import SearchResultCard from "@/components/SearchResult/SearchResultCard";
import SerachResult from "@/components/SearchResult/SearchResultInfo";
    ...
    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5">
      ...
      <div id="main-content" className="flex flex-col gap-5">
        ...
        <div className="flex justify-between flex-col gap-3 lg:flex-row ">
          <SerachResult total={results.pagination.total} city={city}/>
          <SortOptionDropDown 
